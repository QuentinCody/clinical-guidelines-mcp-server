...
/**
 * Regression tests for clinical-guidelines-mcp-server structuredContent responses.
 */
...
if (index) {
  assertContains('src/index.ts', index, 'GuidelinesDataDO', 'index exports GuidelinesDataDO');
...
if (codeMode) {
  assertContains('src/tools/code-mode.ts', codeMode, 'guidelines_search', 'code-mode registers guidelines_search');
  assertContains('src/tools/code-mode.ts', codeMode, 'guidelines_execute', 'code-mode registers guidelines_execute');
}

if (queryData) {
  assertContains('src/tools/query-data.ts', queryData, 'guidelines_query_data', 'registers guidelines_query_data');
}

if (getSchema) {
  assertContains('src/tools/get-schema.ts', getSchema, 'guidelines_get_schema', 'registers guidelines_get_schema');
}
